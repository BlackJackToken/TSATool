...
In addition, you can skip the M4 washers if you print two copies of *"tsa_tool_spacer.stl"*, though the action is much smoother with the metal washers.
...
proof of concept by [Steven Knuchel (Xylitol)](http://www.xylibox.com/), which I then refined into workable keys by
experimentation and with input from a number of testers.
